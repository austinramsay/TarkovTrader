...
public class LoginPrompt {
    ...
    private void submit()
    {
        ...
        if ((TarkovTrader.userPrefs.get(Preferences.USERNAME) != null) || (TarkovTrader.userPrefs.get(Preferences.PASSWORD) != null) || (!prefsValue.equals(TarkovTrader.userPrefs.get(Preferences.REMEMBER_ME)))) {
                    ...
                    !TarkovTrader.userPrefs.get(Preferences.PASSWORD).equals(passwordInput.getText()))
            {
                ...
                else
                {
                    ...
                    TarkovTrader.updatePrefs(Preferences.REMEMBER_ME, prefsValue);
                    TarkovTrader.updatePrefs(Preferences.USERNAME, "");
                    TarkovTrader.updatePrefs(Preferences.PASSWORD, "");
                }
            }
        }
